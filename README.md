...
Publicamos con ```npm publish --access public```. Vemos que se ha publicado correctamente en la [página de npm](https://www.npmjs.com/package/martamolf19?activeTab=readme):
